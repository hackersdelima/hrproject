    	...
    	<div class="col-md-6 col-centered" style="text-align: center;padding-bottom: 10px;">
    		...
    		<table style="width:80%; margin:auto;">
    			<tr>
    				...
    				<td><form:input path="name" cssClass="uname" id="name" placeholder="Enter Name"/></td>
    			</tr>
    			<tr>
    				<td colspan="2"><label for="citizenship-no">Citizenship No</label></td>
    				<td><form:input path="citizenshipno" cssClass="uname" id="citizenship-no" placeholder="Enter Citizenship No"/></td>
    			</tr>
    			<tr>
    				<td colspan="2"><label for="phone-no">Phone Number</label></td>
    				<td><form:input path="phonenumber" cssClass="uname" id="phone-no" placeholder="Enter Phone Number"/></td>
    			</tr>
    			<tr>
    				<td colspan="2"><label for="phone-no">Email</label></td>
    				<td><form:input path="email" cssClass="uname" id="email" placeholder="Enter Email"/></td>
    			</tr>
    			<tr>
    			...
    			<tr>
    				...
    				<td><input type="submit" class="form-control pull-right" value="Signup"></td>
    			</tr>
